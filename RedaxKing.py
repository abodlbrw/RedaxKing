def xub():
    ...
    console = Console()
    r1 = requests.get("https://pastebin.com/wBuhXEgw").text
    if basesplit in r1:
      console.print("ACTIVE : "+basesplit,style="bold r green")
      time.sleep(1)
      pass
    else:
      console.print(" YOUR ID : "+basesplit,style="bold r red ")
      sys.exit() 
      xub()
...
│☞  YOUTUBE    ➟   Abody-Issa                     │
│☞  VERSION    ➟   0.1                             │
│☞  GROUP : Arab social media marketing  │
╚ⒽⒷⒻ══════[ 𓆩𝐇𝐈𝐋𝐀𝐑𝐈𝐎𝐔𝐒𓆪 𓆩𝐁𝐑𝐔𝐓𝐄𓆪  𓆩𝐅𝐎𝐑𝐂𝐄𓆪 ]══════ⒽⒷⒻ╝
\033[1;32m 
\033[1;33m 
\033[1;34m 
\033[1;35m 
